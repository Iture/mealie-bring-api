...
| `USE_FUZZY_MATCHING`      | Flag determining if fuzzy matching item names should be performed (tries to find the best matching name from Bring list)                                                                             |    No    | `true`                              | `false`                       |
